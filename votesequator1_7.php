...
<html>
<?php
include ("validation.votesequator1_7.php");
...
<h1 style="font-size:30;color:#0000FF;">Equator 1-7 candidates</h1>
<head>
<style>
table
{
...
$query=mysql_query("SELECT * FROM equator1_7")or die(mysql_error());
...
<a href="result.eq1-7.php">result</a>
