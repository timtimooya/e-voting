...
<html>
<?php
include ("validation.vetfarmladies.php");
...
<h1 style="font-size:30;color:#0000FF;">Vetfarm ladies candidate</h1>
<head>
<style>
table
{
...
$query=mysql_query("SELECT * FROM vetfarmladies")or die(mysql_error());
...
<a href="result.vetfarmladies.php">result</a>
