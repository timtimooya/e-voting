...
<html>
<?php
include ("validation.voteshealth.php");
if (isset($_SESSION['voted'])){
	//echo '<script>alert("already voted")</script>';
	//header ("location:voteshealth.php");
...
$query=mysql_query("SELECT * FROM health")or die(mysql_error());
...
<a href="result.health.php">result</a>
