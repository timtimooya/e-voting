...
//LIMIT 0 , 30
	...
	mysql_query("INSERT INTO resultpresident (v_id, count) SELECT v_id, COUNT( * ) `Count` FROM votespresident GROUP BY v_id ON DUPLICATE KEY UPDATE v_id= values(v_id)") or die (mysql_error());
