...
<html>
<?php
include ("validation.votesentertainment.php");
...
<h1 style="font-size:30;color:#0000FF;">Entertainment candidates</h1>
<head>
<style>
table
{
...
$query=mysql_query("SELECT * FROM entertainment")or die(mysql_error());
...
<a href="result.entertainment.php">result</a>
