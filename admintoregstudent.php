...
<p style="text-align:center;colo:black;"><u>Enter candidates Details here.</u></p>
...
<a href="candidate.vicepresident.php">vice president</a><br>
<a href="adminviewvicepresident.php">View registered candidates</a>
 </form> 
    <?php
...
if ($f!='' && $s!='' && $o=!''&& $a!=''&& $sch!=''&& $co!=''&& $dep!='' &&$po!='' && $ge!='' ){
	$query1= mysql_query("INSERT INTO candidate( firstname ,secondname, othername,rgno,scho,dep,course,post,gender,path) values('$f','$s','o','$a','$sch','$dep','$co','$po','$ge','$filePath' )") or die(mysql_error());
