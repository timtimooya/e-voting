...
<html>
<?php
include ("validation.votesnonresident.php");
...
<h1 style="font-size:30;color:#0000FF;">Non-residents candidates</h1>
<head>
<style>
table
{
...
$query=mysql_query("SELECT * FROM nonresident")or die(mysql_error());
...
<a href="result.nonresident.php">result</a>
