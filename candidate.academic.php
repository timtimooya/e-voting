...
<p style="text-align:center;color:black;"><u>Enter candidates-academicas Details here.</u></p>
...
<a href="candidate.sunrise.php">Hall representative Sunrise</a><br>
<a href="adminviewacademics.php">View registered candidates</a>
 </form> 
    <?php
...
if ($f!='' && $s!='' && $o=!''&& $a!=''&& $sch!=''&& $co!=''&& $dep!='' &&$po!='' && $ge!=''  ){
	$query1 = mysql_query("INSERT INTO academics( firstname ,secondname, othername,rgno,scho,dep,course,post,gender,path) values('$f','$s','o','$a','$sch','$dep','$co','$po','$ge','$filePath' )") or die(mysql_error());
