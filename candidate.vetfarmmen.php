...
<p style="text-align:center;color:black;"><u>Enter hall representative vetfarmmen Details here.</u></p>
...
<a href="adminviewvetfarmmen.php">View registered candidates</a>
 </form> 
    <?php
...
if ($f!='' && $s!='' && $o=!''&& $a!=''&& $sch!=''&& $co!=''&& $dep!='' &&$po!=''){
	$query1 = mysql_query("INSERT INTO vetfarmmen( firstname ,secondname, othername,rgno,scho,dep,course,post,gender,path) values('$f','$s','o','$a','$sch','$dep','$co','$po','$ge','$filePath' )") or die(mysql_error());
}
