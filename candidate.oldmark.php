...
<a href="adminviewoldmark.php">View registered candidates</a>
 </form> 
    <?php
...
if ($f!='' && $s!='' && $o=!''&& $a!=''&& $sch!=''&& $co!=''&& $dep!='' &&$po!='' && $ge!=''){
	$query1 = mysql_query("INSERT INTO oldmark( firstname ,secondname, othername,rgno,scho,dep,course,post,gender,path) values('$f','$s','o','$a','$sch','$dep','$co','$po','$ge','$filePath' )") or die(mysql_error());
