...
<html>
<?php
include ("validation.votesoldmark.php");
...
<h1 style="font-size:30;color:#0000FF;">Oldmark candidates</h1>
<head>
<style>
table
{
...
$query=mysql_query("SELECT * FROM oldmark")or die(mysql_error());
...
<a href="result.oldmark.php">result</a>
