...
<html>
<?php
include ("validation.votesfinance.php");
...
<h1 style="font-size:30;color:#0000FF;">finance secretary candidate</h1>
<head>
<style>
table
{
...
$query=mysql_query("SELECT * FROM finance_secretary")or die(mysql_error());
...
<a href="result.finance.php">result</a>
