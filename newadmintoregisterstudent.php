...
<br><input type= "file" name= "image" required></br></br>
...
if ($f!='' && $s!='' && $o=!''&& $a!=''&& $sch!=''&& $co!=''&& $dep!='' &&$po!='' && $ge!='' && $im!=''  ){
	$query1 = mysql_query("INSERT INTO candidate( firstname ,secondname, othername,rgno,scho,dep,course,post,gender,image) values('$f','$s','o','$a','$sch','$dep','$co','$po','$ge','$im' )") or die(mysql_error());
