...
<html>
<?php
include ("validation.voteskili.php");
...
$query=mysql_query("SELECT * FROM kilimanjaro")or die(mysql_error());
  ...
  echo "<td>" . $row['othername'] . "</td>";
   echo "<td>" . $row['scho'] . "</td>";
    echo "<td>" . $row['course'] . "</td>";
	 ...
	 echo $row['id'];
  echo '<td><input type="checkbox" name=T[] value='.$row['id'].' onclick ="disable1()"/> </td>';
...
<a href="result.kili.php">result</a>
